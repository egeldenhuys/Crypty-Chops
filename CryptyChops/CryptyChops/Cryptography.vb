...
Public Class Cryptography
    ...
    Public Class Reverse
        ...
        Public Shared Sub ApplyAlgortihm(ByVal bytes() As Byte, ByVal destPath As String, ByVal fMode As FileMode)
            ...
            'fReader.CreateFile(destPath, bytes, FileMode.Append)
            fReader.Close()
